...
public class ValueAnimator extends Animator {
     ...
     * during a call to {@link ValueAnimator.AnimatorUpdateListener#onAnimationUpdate(ValueAnimator)}, which
     ...
     * {@link ValueAnimator.AnimatorUpdateListener#onAnimationUpdate(ValueAnimator)}, which
     * is called during each animation frame, immediately after the value is calculated.
     *
    ...
    public String toString() {
        String returnVal = "ValueAnimator@" + Integer.toHexString(1);
        if (mValues != null) {
